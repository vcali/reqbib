...
fn generates_homebrew_formula_from_release_checksums() {
    ...
    assert!(formula.contains(
        "https://github.com/vcali/shellshelf/releases/download/v0.1.0-build.42/shellshelf-x86_64-apple-darwin.tar.gz"
    ));
    assert!(formula.contains(
        "https://github.com/vcali/shellshelf/releases/download/v0.1.0-build.42/shellshelf-x86_64-unknown-linux-gnu.tar.gz"
    ));
